...
var text=item.addClass("menu-org.jit.item").html();
...
menu.find(".menu-org.jit.item").each(function(){
...
if(!item.hasClass("menu-org.jit.item")){
return;
}
item.unbind(".menu");
...
if(menu&&menu.length){
_418(menu);
menu.find("div.menu-org.jit.item").each(function(){
if(this.submenu){
_3f7(this.submenu);
}
$(this).removeClass("menu-active");
...
var tmp=$("<div></div>");
function find(menu){
menu.children("div.menu-org.jit.item").each(function(){
...
var t=$(_41d);
if(!t.hasClass("menu-org.jit.item")){
return;
}
if(_41e){
t.addClass("menu-org.jit.item-disabled");
if(_41d.onclick){
_41d.onclick1=_41d.onclick;
_41d.onclick=null;
}
}else{
t.removeClass("menu-org.jit.item-disabled");
if(_41d.onclick1){
...
var item=$("<div class=\"menu-org.jit.item\"></div>").appendTo(menu);
...
function _426(el){
if(el.submenu){
el.submenu.children("div.menu-org.jit.item").each(function(){
_426(this);
});
...
function _42c(_42d){
$(_42d).children("div.menu-org.jit.item").each(function(){
_423(_42d,this);
});
if(_42d.shadow){
_42d.shadow.remove();
...
var t=$(_433);
var item={target:_433,id:t.attr("id"),text:$.trim(t.children("div.menu-text").html()),disabled:t.hasClass("menu-org.jit.item-disabled"),name:_433.itemName,href:_433.itemHref,onclick:_433.onclick};
...
function _516(){
if(_512.menu){
var item=_512.menu.children("div.menu-org.jit.item:first");
_512.menu.children("div.menu-org.jit.item").each(function(){
...
var item=_9e3.children("div.combobox-org.jit.item-hover");
if(!item.length){
item=_9e3.children("div.combobox-org.jit.item-selected");
}
item.removeClass("combobox-org.jit.item-hover");
var _9e4="div.combobox-org.jit.item:visible:not(.combobox-org.jit.item-disabled):first";
var _9e5="div.combobox-org.jit.item:visible:not(.combobox-org.jit.item-disabled):last";
if(!item.length){
...
if(item.length){
item.addClass("combobox-org.jit.item-hover");
...
_9f4.find("div.combobox-org.jit.item-selected").removeClass("combobox-org.jit.item-selected");
var _9f5=null;
var vv=[],ss=[];
for(var i=0;i<_9f2.length;i++){
var v=_9f2[i];
var s=v;
opts.finder.getEl(_9f1,v).addClass("combobox-org.jit.item-selected");
...
_a02.find("div.combobox-org.jit.item-selected,div.combobox-org.jit.item-hover").removeClass("combobox-org.jit.item-selected combobox-org.jit.item-hover");
_a02.find("div.combobox-org.jit.item,div.combobox-group").hide();
var data=_a00.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
var item=_a07.children("div.combobox-org.jit.item-hover");
if(item.length){
var row=opts.finder.getRow(_a06,item);
var _a08=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-org.jit.item-selected")){
...
$(this).combo("panel").find("div.combobox-org.jit.item:hidden,div.combobox-group:hidden").show();
_9eb(this,$(this).combobox("getValues"),true);
$(this).combobox("scrollTo",$(this).combobox("getValue"));
opts.onShowPanel.call(this);
}}));
$(_a0a).combo("panel").unbind().bind("mouseover",function(e){
$(this).children("div.combobox-org.jit.item-hover").removeClass("combobox-item-hover");
var item=$(e.target).closest("div.combobox-org.jit.item");
if(!item.hasClass("combobox-org.jit.item-disabled")){
item.addClass("combobox-org.jit.item-hover");
}
e.stopPropagation();
}).bind("mouseout",function(e){
$(e.target).closest("div.combobox-org.jit.item").removeClass("combobox-item-hover");
e.stopPropagation();
}).bind("click",function(e){
var _a0c=$(this).panel("options").comboTarget;
var item=$(e.target).closest("div.combobox-org.jit.item");
if(!item.length||item.hasClass("combobox-org.jit.item-disabled")){
return;
}
...
_a19.find("div.combobox-org.jit.item-selected").removeClass("combobox-org.jit.item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
var cls="combobox-org.jit.item"+(row.disabled?" combobox-org.jit.item-disabled":"")+(g?" combobox-gitem":"");
